...
class LLM:
    def __init__(self, config: ModelConfig, system_prompt: Optional[str] = None):  # noqa: D107
        self.config = config
    ...
    def invoke(
        ...
        if self.system_prompt:
            messages.insert(0, SystemMessage(content=[{"type": "text", "text": self.system_prompt}]))
